...
--#
--dim_age
CREATE TABLE IF NOT EXISTS dim_target_group
(
    "dim_target_group_key"  INT                     GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
--#
--dim_status default
INSERT INTO dim_target_group ("dim_target_group_key","target_group","target_description","age_lower_limit","age_upper_limit")
VALUES (-1,'-unknown-','-unknown-',0,0);
--#
...
(
    ...
    "dim_target_group_key"      INT             NOT NULL    REFERENCES dim_target_group(dim_target_group_key),
    ...
    "created_ts"                TIMESTAMP       DEFAULT     CURRENT_TIMESTAMP,
    "updated_ts"                TIMESTAMP       DEFAULT     CURRENT_TIMESTAMP,
    UNIQUE("dim_week_start_date_key", "dim_week_end_date_key", "dim_country_key", "dim_vaccine_key", "dim_target_group_key")
);
--#
...
(
    ...
    "created_ts"                TIMESTAMP       DEFAULT     CURRENT_TIMESTAMP,
    "updated_ts"                TIMESTAMP       DEFAULT     CURRENT_TIMESTAMP,
    UNIQUE("dim_week_start_date_key", "dim_week_end_date_key", "dim_country_key", "dim_region_key", "dim_vaccine_key", "dim_target_group_key")
);
--#
...
(
    ...
    "created_ts"                TIMESTAMP       DEFAULT     CURRENT_TIMESTAMP,
    "updated_ts"                TIMESTAMP       DEFAULT     CURRENT_TIMESTAMP,
    UNIQUE("dim_date_key", "dim_country_key", "dim_source_key")
);
--#
...
(
    ...
    "created_ts"                TIMESTAMP       DEFAULT     CURRENT_TIMESTAMP,
    "updated_ts"                TIMESTAMP       DEFAULT     CURRENT_TIMESTAMP,
    UNIQUE("dim_week_start_date_key", "dim_week_end_date_key", "dim_country_key", "dim_source_key")
);
